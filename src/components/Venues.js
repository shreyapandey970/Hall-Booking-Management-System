...
const Venues = () => {
    ...
    <div className='vcard'>
      ...
      <div id="venuecard1">
        <h3 id="margin1"><a href="https://www.tinkercad.com/things/2ef51ZJHrrk-our-ski-venue/edit"> <img src={require('../photos/v1.jpeg')} height={163} width={363} alt="logo" /></a></h3>
...
Rajokri, Stellar Resorts, NH8, New Delhi, India</a>
    ...
    <div id="dark">
  <Link to="/Darkvenues"><img src={require('../photos/darkmode.png')} height={35} width={35} />
  </Link>
  </div>
