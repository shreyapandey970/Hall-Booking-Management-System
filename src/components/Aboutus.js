...
//import "./style.css";
//import images from "./imagesapi.js";
...
const Aboutus = () => {
  return (
    ...
    <h3 id="aboutimg"><img src={require('../photos/aboutus.jpg')} height={400} width={600} alt="logo" /></h3>
    <p id="tc">India's favourite event planning website & app with over 1.5 millon monthly dedicated users. ​SkiEvent is​ a ​swanky alternative to the outdated event planning process. A one-stop-shop for all things events, you can find
...
<div id="dark">
  <Link to="/Darkaboutus"><img src={require('../photos/darkmode.png')} height={35} width={35} />
  </Link>
  </div>
...
export default Aboutus; //default